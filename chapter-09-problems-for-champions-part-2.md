...
Тествайте решението си тук: [https://judge.softuni.bg/Contests/Practice/Index/1062#0](https://judge.softuni.bg/Contests/Practice/Index/1062#0).
...
Входните данни се състоят от точно един ред от конзолата. За да имаме достъп до всеки един елемент от числовия израз, ще прочетем входа, чрез `input()` командата и после ще превърнем входния `string` в масив от символи. Използвайки `pop(..)` можем да достъпваме символите един по един.
...
Относно кода по-горе трябва да поясним два детайла. Първият е използването на тип **`float`** за **съхранение на резултата на нашето уравнение**. Вторият е стойността по подразбиране на оператора - тя е **`+`**, за да може още първото срещнато число да бъде събрано с резултата ни.
...
> Забележка: за да вземем ASCII кода на даден символ ползваме `ord(..)` метода.
...
Тествайте решението си тук: [https://judge.softuni.bg/Contests/Practice/Index/1062#1](https://judge.softuni.bg/Contests/Practice/Index/1062#1).
...
![Input read](/assets/chapter-9-2-images/03.Bulls-and-cows-03.png)
...
![Flag set](/assets/chapter-9-2-images/03.Bulls-and-cows-04.png)
...
![No case](/assets/chapter-9-2-images/03.Bulls-and-cows-05.png)
...
![Digit generation](/assets/chapter-9-2-images/03.Bulls-and-cows-06.png)
...
![Guess set](/assets/chapter-9-2-images/03.Bulls-and-cows-07.png)
...
![Checks set](/assets/chapter-9-2-images/03.Bulls-and-cows-08.png)
...
![Single check](/assets/chapter-9-2-images/03.Bulls-and-cows-09.png)
...
![Case check](/assets/chapter-9-2-images/03.Bulls-and-cows-10.png)
...
![Root check](/assets/chapter-9-2-images/03.Bulls-and-cows-11.png)

### Тестване в Judge системата

Тествайте решението си тук: [https://judge.softuni.bg/Contests/Practice/Index/1062#2](https://judge.softuni.bg/Contests/Practice/Index/1062#2).
