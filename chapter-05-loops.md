...
<div class="video-player">
  ...
  href="https://www.youtube.com/watch?v=pvTMTGsooMk&feature=youtu.be">
  https://www.youtube.com/watch?v=pvTMTGsooMk&feature=youtu.be</a>.
</div>
...
* Числата се сумират и накрая се отпечатва резултата.
...
Създаваме нов проект в PyCharm, за да организираме по-добре задачите за упражнение. Целта на този **проект** e да съдържа **по един Python файл за всяка задача** от упражненията.
...
Ще използваме външната библиотека `turtle`. Тя дефинира клас `Turtle`, който представлява **костенурка за рисуване**. За да я използваме, добавяме следния код, най-отгоре в началото на файла:
...
Отново **стартираме** приложението:
...
Добавете нов Python файл **hexagon**, който чертае правилен шестоъгълник:
...
Добавете нов Python файл **star**, който чертае звезда с 5 върха (**петолъчка**), като на фигурата по-долу:

![](/assets/chapter-5-1-images/13.Turtle-graphics-9.png)

**Подсказка:**

Сменете цвета: **`my_turtle.color("green")`**. 
...
Добавете нов Python файл **spiral**, който чертае спирала с 20 върха като на фигурата по-долу:
...
Добавете нов Python файл **sun**, който чертае слънце с 36 върха като на фигурата по-долу:

![](/assets/chapter-5-1-images/13.Turtle-graphics-11.png)

### Задача: * чертане на спирален триъгълник с костенурката

Добавете нов Python файл **triangle**, който чертае три триъгълника с по 22 върха като на фигурата по-долу:
