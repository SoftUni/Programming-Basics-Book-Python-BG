...
Първата стъпка от решаването на задачата е да прочетем и обработим входните данни. Те се състоят от **5 цели числа**: **3** за редицата на Трибоначи и **2** за числовата спирала:
...
Започваме с вмъкване на необходимите функционалност и с четенето от входните данни от конзолата. В случая вмъкваме типа **`date`** (с ново име **`datetype`**), функциите **`timedelta`** и **`floor`** и четем **3 цели числа**:
