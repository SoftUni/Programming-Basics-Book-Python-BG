...
Във PyCharm създаваме **нов Python проект с име „FirstStepsInProgramming“**:
...
Подреждаме следните компоненти (контроли):
...
![](/assetschapter-1-images/07.Numbers-sum-05.PNG)
...
Стартираме отново програмата с с [**Ctrl + Shift + F10**] или с десен бутон - **[Run]**, и проверяваме дали работи коректно. Правим опит да сметнете **4 + 5**, а след това **-25 + 1.5**:
