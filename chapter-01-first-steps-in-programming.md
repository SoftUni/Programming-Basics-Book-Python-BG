...
За програмиране на **езика Python** най-често се ползва средата за разработка **PyCharm**, която се разработва и разпространява от JetBrains и може да се изтегли от: [https://www.jetbrains.com/pycharm](https://www.jetbrains.com/pycharm). Алтернативи на PyCharm са **Atom** (https://atom.io), **Visual Studio Code** (https://code.visualstudio.com), **Eclipse** (http://www.icsharpcode.net/OpenSource/SD) и други. В настоящата книга ще използваме средата за разработка PyCharm.
...
Нашата първа програма ще се състои от единична **Python команда**, която свири музикалната нота "ла" (432 херца) с продължителност половин секунда (500 милисекунди):
...
PyCharm ще създаде за нас **празен проект**, в който може да добавяме Python файлове. Добавяме нов Python файл... TODO
...
В горния пример **`Print`** е изписано грешно и трябва да се поправи на **`print`**. В езика Python липсва **точка и запетая**  (**`;`**) в края на командите. Командите се разделят една от друга чрез нов ред и индентация (отстъп).
