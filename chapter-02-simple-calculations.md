...
// TODO
За да прочетем потребителски вход под формата на цяло число, е необходимо да използваме вградения метод **`int()`**, чрез който ще преобразуваме подадения вход към integer:
