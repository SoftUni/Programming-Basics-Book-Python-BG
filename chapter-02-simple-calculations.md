...
Създаваме бутон с **текст Catch me!** и **и команда - функцията `on_click()`**, която ще напишем по-късно. Визуализираме компонентите чрез метода **`pack()`**. Нека и двата компонента са **най-отгоре (top)**.
...
За преместването на бутона на случайна позиция ще използваме **модула random**.
