...
В **Python** използваме вградения метод **`.format(…)`**, чрез който изреждаме променливите, които искаме да са на мястото на шаблоните (плейсхолдърите).
...
Възможно е не всичко да тръгне гладко от първия път. Примерите по-горе съдържат **неизучаван материал** и имат за цел да ви запалят любопиството и да ви накарат да се поразровите в Интернет и **да потърсите сами решения** за възникващите трудности.
