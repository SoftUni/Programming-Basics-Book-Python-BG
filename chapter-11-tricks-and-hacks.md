...
Официалната **Python код конвенция** на PSF е публикувана в страницата **PEP 8 &mdash; Style Guide for Python Code**[https://www.python.org/dev/peps/pep-0008/](https://www.python.org/dev/peps/pep-0008/). Важно е да се отбележи, че в примерите, които сме давали до сега и ще даваме занапред в тази книга, се ръководим основно от нея.
...
Когато бъде стартиран, кодът дава следната грешка и програмата спира работа: ***`IndentationError: expected an indented block`.**
...
За наше удобство има **бързи клавиши в PyCharm**, за които ще обясним по-късно в настоящата глава, но засега ни интересуват една комбинация. Тя е за **форматиране на кода** в целия документ: [**CTRL + ALT + L**]. 
