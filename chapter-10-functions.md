...
**Декларираме** функцията и **списъка** ѝ с **параметри**, след което пишем кода, който тя ще изпълнява.
