...
<i><u>Забележка:</u> За да използваме </i>**`math.ceil()`**<i>, която закръгля към по-голямото цяло число, без значение от дробната част, е необходимо да импортираме библиотеката </i>**`math`**<i>. Това става с командата </i>**`import math`**<i>. Препоръчително е да я напишем още в началото на файла.</i>
